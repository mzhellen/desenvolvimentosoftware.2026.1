    ...
    <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-gray-900 border-t border-gray-800 z-50 pb-safe">
      ...
      */}
      <div className="flex items-center justify-between overflow-x-auto gap-4 py-2 px-4 no-scrollbar">
        ...
        {/* Diagnóstico */}
        <Link href="/diagnostico" className="flex flex-col items-center gap-1 min-w-[50px] text-gray-500 hover:text-gray-300 transition-colors">
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        {/* Rotina */}
        <Link href="/rotina" className="flex flex-col items-center gap-1 min-w-[50px] text-gray-500 hover:text-gray-300 transition-colors">
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        {/* Lembretes */}
        <Link href="/lembretes" className="flex flex-col items-center gap-1 min-w-[50px] text-gray-500 hover:text-gray-300 transition-colors">
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        {/* Dicas */}
        <Link href="/dicas" className="flex flex-col items-center gap-1 min-w-[50px] text-gray-500 hover:text-gray-300 transition-colors">
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
